pipeline {
    ...
    stages {
      stage('CI Build and push snapshot') {
        ...
        steps {
          dir ('/home/jenkins/go/src/github.com/odzhu/go8') {
            checkout scm
            container('go') {
              sh "make linux"
          ...
          dir ('/home/jenkins/go/src/github.com/odzhu/go8/charts/preview') {
            container('go') {
              sh "make preview"
      ...
      stage('Build Release') {
        ...
        steps {
          container('go') {
            ...
            dir ('/home/jenkins/go/src/github.com/odzhu/go8/charts/go8') {
